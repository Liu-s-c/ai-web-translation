...
> AI极速翻译 · 自动识别英文网页 · 上下文理解与特定名称、术语优化

一款专注于**英文网页 → 简体中文**AI智能翻译的 Chrome / Edge 扩展,翻译质量与速度远超浏览器原生翻译功能。支持白名单与悬停原文对照。
...
- **精致 UI** —— iOS毛玻璃导航栏、原生开关、流畅动画与精致视觉。
...
- **API 配置**:管理 API Key；前往Deepseek开放平台获取API Key。
- **术语表**:添加 `原文术语 → 译文`,统一译法。
